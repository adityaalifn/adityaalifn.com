    ...
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8 bg-gradient-to-br from-blue-500 to-purple-500 overflow-y-auto">
      ...
      >
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <p className="text-base sm:text-lg text-justify">
            Currently, I'm <strong>developing an internal routing engine</strong> capable of directions, live tracking, and map-matching, which is set to replace Google Maps API and potentially save millions of dollars in annual costs. Throughout my tenure, I've demonstrated <strong>strong problem-solving skills, adaptability to diverse roles, and the ability to effectively communicate complex technical concepts</strong> to both technical and non-technical stakeholders.
          </p>
